        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: const Text('Featured', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
            ),
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 16),
              child: const Text('Hidden Gems', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
            ),
            const SizedBox(height: 16),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 16),
